...
public class ViewPagerIndicator extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(x + (mPosition%mItemCount + mPositionOffset) * wg, y);
    ...
    public void setupWithViewPager(ViewPager pager) {
        if(pager.getAdapter() instanceof  LoopVPAdapter){
            mItemCount = ((LoopVPAdapter)pager.getAdapter()).getRealCount();
        }else{
