...
/**
 * Created by yishe on 2017/9/28.
 */

public class AcceBallView extends View{
    private static final String TAG= AcceBallView.class.getSimpleName();
    ...
    public AcceBallView(Context context, AttributeSet attrs){
        super(context,attrs);
        init(context);
    }

    public AcceBallView(Context context,AttributeSet attrs,int defStyle){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mState==STATE_STOP){
            ...
            Log.i(TAG,"maxRate="+maxRate+",curRate="+curRate);
